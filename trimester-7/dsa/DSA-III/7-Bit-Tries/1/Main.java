...
/**
 * QUESTION: Given an array, A of integers of size N. Find the subarray A[L],
 * A[L+1], A[L+2], ... A[R] with 1<=L<=R<=N, which has maximum XOR value.
 *
...
public class Main {
    ...
    public ArrayList<Integer> solve(ArrayList<Integer> A) {
        ...
        // This is done for the case where maximum XOR subarray starts from index 0
    ...
    private void insert(TrieNode root, int value, int index) {
        ...
        curr.index = index; // Store the index of the value to be inserted in Trienode at the end.
    }
